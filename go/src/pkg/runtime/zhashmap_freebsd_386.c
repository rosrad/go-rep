...
#line 15 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
enum 
{ 
docheck = 0 , 
debug = 0 , 
...
bool eq; 
byte *k , *v; 
#line 33 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
cnt = 0; 
#line 36 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
#line 59 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( h->oldbuckets != nil ) { 
...
#line 84 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( cnt != h->count ) { 
runtime·printf ( "%D %D\n" , ( uint64 ) cnt , ( uint64 ) h->count ) ; 
runtime·throw ( "entries missing" ) ; 
} 
} 
#line 90 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static void 
...
uint8 flags; 
#line 98 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
flags = 0; 
#line 101 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
keysize = t->key->size; 
...
#line 119 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
#line 135 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
B = 0; 
while ( hint > BUCKETSIZE && hint > LOAD * ( ( uintptr ) 1 << B ) ) 
B++; 
#line 141 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( checkgc ) mstats.next_gc = mstats.heap_alloc; 
if ( B == 0 ) { 
#line 144 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
buckets = nil; 
} else { 
buckets = runtime·cnewarray ( t->bucket , ( uintptr ) 1 << B ) ; 
} 
#line 150 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
h->count = 0; 
h->B = B; 
h->flags = flags; 
h->keysize = keysize; 
...
#line 167 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static void 
...
uint8 top; 
bool eq; 
#line 182 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
b = ( Bucket* ) ( h->oldbuckets + oldbucket * h->bucketsize ) ; 
newbit = ( uintptr ) 1 << ( h->B - 1 ) ; 
#line 185 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( !evacuated ( b ) ) { 
#line 189 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
#line 209 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
hash = h->hash0; 
t->key->alg->hash ( &hash , t->key->size , IK ( h , k ) ) ; 
if ( ( h->flags & Iterator ) != 0 ) { 
t->key->alg->equal ( &eq , t->key->size , IK ( h , k ) , IK ( h , k ) ) ; 
if ( !eq ) { 
#line 225 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( ( top & 1 ) != 0 ) 
hash |= newbit; 
else 
hash &= ~newbit; 
...
#line 235 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( ( hash & newbit ) == 0 ) { 
...
#line 290 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
#line 298 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( oldbucket == h->nevacuate ) { 
h->nevacuate = oldbucket + 1; 
if ( oldbucket + 1 == newbit ) 
#line 302 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
h->oldbuckets = nil; 
} 
if ( docheck ) 
check ( t , h ) ; 
} 
#line 308 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static void 
grow_work ( MapType *t , Hmap *h , uintptr bucket ) 
{ 
uintptr noldbuckets; 
#line 313 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
noldbuckets = ( uintptr ) 1 << ( h->B - 1 ) ; 
#line 317 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
evacuate ( t , h , bucket & ( noldbuckets - 1 ) ) ; 
#line 320 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( h->oldbuckets != nil ) 
evacuate ( t , h , h->nevacuate ) ; 
} 
#line 324 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static void 
...
byte *new_buckets; 
uint8 flags; 
#line 332 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( h->oldbuckets != nil ) 
...
if ( ( h->flags & Iterator ) != 0 ) 
flags |= OldIterator; 
#line 342 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
h->B++; 
h->flags = flags; 
h->oldbuckets = old_buckets; 
h->buckets = new_buckets; 
h->nevacuate = 0; 
#line 350 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
} 
#line 356 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static byte* 
...
bool eq; 
byte *k , *k2 , *v; 
#line 368 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
key = *keyp; 
if ( docheck ) 
check ( t , h ) ; 
if ( h->count == 0 ) 
...
#line 474 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static void 
...
byte *k , *v; 
byte *kmem , *vmem; 
#line 489 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
hash = h->hash0; 
t->key->alg->hash ( &hash , t->key->size , key ) ; 
...
#line 496 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
again: 
bucket = hash & ( ( ( uintptr ) 1 << h->B ) - 1 ) ; 
if ( h->oldbuckets != nil ) 
...
if ( !eq ) 
continue; 
#line 521 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
#line 533 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( h->count >= LOAD * ( ( uintptr ) 1 << h->B ) && h->count >= BUCKETSIZE ) { 
hash_grow ( t , h ) ; 
goto again; 
} 
#line 538 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( inserti == nil ) { 
#line 540 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( checkgc ) mstats.next_gc = mstats.heap_alloc; 
...
#line 549 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( ( h->flags & IndirectKey ) != 0 ) { 
if ( checkgc ) mstats.next_gc = mstats.heap_alloc; 
...
#line 569 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static void 
...
byte *k , *v; 
bool eq; 
#line 580 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
if ( h->count == 0 ) 
return; 
...
if ( !eq ) 
continue; 
#line 601 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( ( h->flags & IndirectKey ) != 0 ) { 
* ( byte** ) k = nil; 
} else { 
...
#line 612 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
b->tophash[i] = Empty; 
h->count--; 
#line 617 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
return; 
} 
...
#line 631 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static void 
hash_iter_init ( MapType *t , Hmap *h , Hiter *it ) 
{ 
uint32 old; 
#line 636 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( sizeof ( Hiter ) / sizeof ( uintptr ) != 10 ) { 
runtime·throw ( "hash_iter size incorrect" ) ; 
} 
it->t = t; 
it->h = h; 
#line 643 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
it->B = h->B; 
it->buckets = h->buckets; 
#line 647 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
it->bucket = 0; 
it->offset = runtime·fastrand1 ( ) & ( BUCKETSIZE - 1 ) ; 
it->done = false; 
it->bptr = nil; 
#line 654 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
for ( ;; ) { 
old = h->flags; 
...
#line 662 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( h->buckets == nil ) { 
#line 665 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
it->done = true; 
} 
} 
#line 671 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static void 
hash_next ( Hiter *it ) 
{ 
Hmap *h; 
...
byte *k , *v; 
byte *rk , *rv; 
#line 685 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
h = it->h; 
t = it->t; 
bucket = it->bucket; 
b = it->bptr; 
...
#line 692 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
next: 
if ( b == nil ) { 
if ( it->done ) { 
#line 696 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
it->key = nil; 
it->value = nil; 
return; 
} 
if ( h->oldbuckets != nil && it->B == h->B ) { 
#line 705 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
if ( check_bucket >= 0 ) { 
#line 737 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
t->key->alg->equal ( &eq , t->key->size , IK ( h , k ) , IK ( h , k ) ) ; 
if ( eq ) { 
#line 741 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
hash = h->hash0; 
t->key->alg->hash ( &hash , t->key->size , IK ( h , k ) ) ; 
...
#line 754 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
#line 761 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
it->key = IK ( h , k ) ; 
it->value = IV ( h , v ) ; 
} else { 
#line 766 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
t->key->alg->equal ( &eq , t->key->size , IK ( h , k ) , IK ( h , k ) ) ; 
if ( eq ) { 
#line 773 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
rk = IK ( h , k ) ; 
...
#line 784 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
it->key = IK ( h , k ) ; 
it->value = IV ( h , v ) ; 
} 
} 
...
reflect·ismapkey(Type* typ, bool ret)
{
	ret = 0;
	FLUSH(&ret);
#line 804 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"

	ret = typ != nil && typ->alg->hash != runtime·nohash;
	FLUSH(&ret);
}

#line 808 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
static Hmap* 
makemap_c ( MapType *typ , int64 hint ) 
{ 
Hmap *h; 
Type *key; 
#line 814 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
key = typ->key; 
#line 816 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( sizeof ( Hmap ) > 48 ) 
runtime·panicstring ( "hmap too large" ) ; 
#line 819 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( hint < 0 || ( int32 ) hint != hint ) 
runtime·panicstring ( "makemap: size out of range" ) ; 
#line 822 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( key->alg->hash == runtime·nohash ) 
runtime·throw ( "runtime.makemap: unsupported map key type" ) ; 
#line 825 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
h = runtime·cnew ( typ->hmap ) ; 
hash_init ( typ , h , hint ) ; 
#line 831 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
if ( debug ) { 
runtime·printf ( "makemap: map=%p; keysize=%p; valsize=%p; keyalg=%p; valalg=%p\n" , 
h , key->size , typ->elem->size , key->alg , typ->elem->alg ) ; 
} 
#line 836 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
return h; 
} 
void
runtime·makemap(MapType* typ, int64 hint, Hmap* ret)
{
	ret = 0;
	FLUSH(&ret);
#line 839 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
reflect·makemap(MapType* t, Hmap* ret)
{
	ret = 0;
	FLUSH(&ret);
#line 843 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
runtime·mapaccess1(MapType* t, Hmap* h, byte* key, byte* val)
{
	val = 0;
	FLUSH(&val);
#line 850 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
runtime·mapaccess2(MapType* t, Hmap* h, byte* key, byte* val, bool pres)
{
	...
	pres = 0;
	FLUSH(&pres);
#line 877 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
reflect·mapaccess(MapType* t, Hmap* h, byte* key, byte* val)
{
	val = 0;
	FLUSH(&val);
#line 910 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
{
#line 919 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
{
#line 943 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
{
#line 964 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
{
#line 987 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
{
#line 1006 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
reflect·mapiterinit(MapType* t, Hmap* h, Hiter* it)
{
	it = 0;
	FLUSH(&it);
#line 1034 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
{
#line 1040 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
{
#line 1054 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
reflect·mapiterkey(Hiter* it, byte* key)
{
	key = 0;
	FLUSH(&key);
#line 1058 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
reflect·maplen(Hmap* h, intgo len)
{
	len = 0;
	FLUSH(&len);
#line 1063 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
...
#line 1074 "/home/14/ren/source/golang/go/src/pkg/runtime/hashmap.goc"
