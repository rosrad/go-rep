...
#line 16 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
enum { 
debug = 0 , 
} ; 
#line 20 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static Timers timers; 
static void addtimer ( Timer* ) ; 
static void dumptimers ( int8* ) ; 
#line 25 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
...
time·runtimeNano(int64 ns)
{
	ns = 0;
	FLUSH(&ns);
#line 33 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
...
time·Sleep(int64 ns)
{
#line 38 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
...
#line 57 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static void timerproc ( void ) ; 
static void siftup ( int32 ) ; 
static void siftdown ( int32 ) ; 
#line 62 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static void 
ready ( int64 now , Eface e ) 
{ 
USED ( now ) ; 
#line 67 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
runtime·ready ( e.data ) ; 
} 
#line 70 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static FuncVal readyv = { ( void ( * ) ( void ) ) ready } ; 
#line 73 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
void 
...
#line 90 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static FuncVal timerprocv = { timerproc } ; 
#line 92 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
void 
...
#line 102 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static void 
addtimer ( Timer *t ) 
{ 
int32 n; 
...
#line 149 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
bool 
...
#line 190 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static void 
timerproc ( void ) 
{ 
int64 delta , now; 
...
#line 254 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static void 
siftup ( int32 i ) 
{ 
int32 p; 
int64 when; 
Timer **t , *tmp; 
#line 261 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
t = timers.t; 
when = t[i]->when; 
tmp = t[i]; 
while ( i > 0 ) { 
...
#line 276 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static void 
siftdown ( int32 i ) 
{ 
int32 c , c3 , len; 
int64 when , w , w3; 
Timer **t , *tmp; 
#line 283 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
t = timers.t; 
len = timers.len; 
when = t[i]->when; 
tmp = t[i]; 
...
#line 319 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
static void 
dumptimers ( int8 *msg ) 
{ 
Timer *t; 
int32 i; 
#line 325 "/home/14/ren/source/golang/go/src/pkg/runtime/time.goc"
