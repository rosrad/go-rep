...
#line 12 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
String runtime·emptystring; 
#pragma textflag NOSPLIT

#line 15 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
intgo 
runtime·findnull ( byte *s ) 
{ 
intgo l; 
#line 20 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
if ( s == nil ) 
return 0; 
for ( l=0; s[l]!=0; l++ ) 
; 
...
#line 27 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
intgo 
runtime·findnullw ( uint16 *s ) 
{ 
intgo l; 
#line 32 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
if ( s == nil ) 
return 0; 
for ( l=0; s[l]!=0; l++ ) 
; 
...
#line 39 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
uintptr runtime·maxstring = 256; 
#line 41 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
static String 
...
#line 59 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
String 
...
#line 71 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
String 
...
#line 82 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
Slice 
runtime·gobytes ( byte *p , intgo n ) 
{ 
Slice sl; 
#line 87 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
...
#line 94 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
String 
...
runtime·cstringToGo(byte* str, String s)
{
	...
	s.len = 0;
	FLUSH(&s);
#line 104 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"

	s = runtime·gostringnocopy(str);
	FLUSH(&s);
}

#line 108 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
String 
...
#line 131 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
String 
...
#line 147 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
static String 
...
runtime·concatstring3(String s1, String s2, String s3, String res)
{
	...
	res.len = 0;
	FLUSH(&res);
#line 184 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
...
runtime·concatstring5(String s1, String s2, String s3, String s4, String s5, String res)
{
	...
	res.len = 0;
	FLUSH(&res);
#line 197 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
...
#line 221 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
int32 
runtime·strcmp ( byte *s1 , byte *s2 ) 
{ 
uintptr i; 
byte c1 , c2; 
#line 227 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
for ( i=0;; i++ ) { 
c1 = s1[i]; 
c2 = s2[i]; 
if ( c1 < c2 ) 
...
#line 239 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
int32 
runtime·strncmp ( byte *s1 , byte *s2 , uintptr n ) 
{ 
uintptr i; 
byte c1 , c2; 
#line 245 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
for ( i=0; i<n; i++ ) { 
c1 = s1[i]; 
c2 = s2[i]; 
if ( c1 < c2 ) 
...
#line 258 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
byte* 
runtime·strstr ( byte *s1 , byte *s2 ) 
{ 
byte *sp1 , *sp2; 
#line 263 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
if ( *s2 == 0 ) 
return s1; 
for ( ; *s1; s1++ ) { 
if ( *s1 != *s2 ) 
...
runtime·stringtoslicebyte(String s, Slice b)
{
	...
	b.cap = 0;
	FLUSH(&b);
#line 297 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
...
#line 367 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
enum 
{ 
Runeself = 0x80 , 
} ; 
...
runtime·stringiter(String s, intgo k, intgo retk)
{
	retk = 0;
	FLUSH(&retk);
#line 372 "/home/14/ren/source/golang/go/src/pkg/runtime/string.goc"
