...
#line 37 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
enum 
{ 
PollBlockSize = 4*1024 , 
} ; 
#line 42 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
struct PollDesc 
{ 
PollDesc* link; 
#line 51 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
Lock; 
uintptr fd; 
bool closing; 
uintptr seq; 
...
#line 64 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static struct 
{ 
Lock; 
PollDesc* first; 
#line 73 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
} pollcache; 
#line 75 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
...
#line 83 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
...
net·runtimeNano(int64 ns)
{
	ns = 0;
	FLUSH(&ns);
#line 88 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
...
{
#line 92 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
...
{
#line 164 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
...
#line 254 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
uintptr 
runtime·netpollfd ( PollDesc *pd ) 
{ 
return pd->fd; 
} 
#line 260 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
void** 
runtime·netpolluser ( PollDesc *pd ) 
{ 
return &pd->user; 
} 
#line 266 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
bool 
runtime·netpollclosing ( PollDesc *pd ) 
{ 
return pd->closing; 
} 
#line 272 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
void 
runtime·netpolllock ( PollDesc *pd ) 
{ 
runtime·lock ( pd ) ; 
} 
#line 278 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
void 
runtime·netpollunlock ( PollDesc *pd ) 
{ 
runtime·unlock ( pd ) ; 
} 
#line 285 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
void 
...
#line 305 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static intgo 
...
#line 315 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static bool 
blockcommit ( G *gp , G **gpp ) 
{ 
return runtime·casp ( gpp , WAIT , gp ) ; 
} 
#line 323 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static bool 
...
#line 357 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static G* 
netpollunblock ( PollDesc *pd , int32 mode , bool ioready ) 
{ 
G **gpp , *old , *new; 
#line 362 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
gpp = &pd->rg; 
if ( mode == 'w' ) 
gpp = &pd->wg; 
#line 366 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
for ( ;; ) { 
old = *gpp; 
if ( old == READY ) 
return nil; 
if ( old == nil && !ioready ) { 
#line 373 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
return nil; 
} 
new = nil; 
if ( ioready ) 
...
#line 386 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static void 
...
uint32 seq; 
G *rg , *wg; 
#line 393 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
USED ( now ) ; 
pd = ( PollDesc* ) arg.data; 
#line 397 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
seq = ( uintptr ) arg.type; 
rg = wg = nil; 
runtime·lock ( pd ) ; 
if ( seq != pd->seq ) { 
#line 402 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
runtime·unlock ( pd ) ; 
return; 
} 
if ( read ) { 
...
#line 426 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static void 
deadline ( int64 now , Eface arg ) 
{ 
deadlineimpl ( now , arg , true , true ) ; 
} 
#line 432 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static void 
readDeadline ( int64 now , Eface arg ) 
{ 
deadlineimpl ( now , arg , true , false ) ; 
} 
#line 438 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static void 
writeDeadline ( int64 now , Eface arg ) 
{ 
deadlineimpl ( now , arg , false , true ) ; 
} 
#line 444 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
static PollDesc* 
allocPollDesc ( void ) 
{ 
PollDesc *pd; 
uint32 i , n; 
#line 450 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
runtime·lock ( &pollcache ) ; 
if ( pollcache.first == nil ) { 
n = PollBlockSize/sizeof ( *pd ) ; 
if ( n == 0 ) 
n = 1; 
#line 457 "/home/14/ren/source/golang/go/src/pkg/runtime/netpoll.goc"
